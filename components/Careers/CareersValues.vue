  ...
  <section class="py-16 border-b border-b-secondary/10">
    <div>
      <div class="text-center mb-12">
        <UiHeading level="2">Почему стоит выбрать именно нас?</UiHeading>
        <UiText class="mx-auto mt-4 max-w-2xl">
          Мы создаем культуру, в которой инновации, сотрудничество и рост являются нашими главными приоритетами.
        </UiText>
      </div>
      ...
      <div class="grid gap-8 md:grid-cols-3">
        <div>
          ...
          <UiText>
            Мы ценим профессиональное развитие и обеспечиваем возможности для непрерывного обучения и роста карьеры.
          </UiText>
        </div>
        ...
        <div>
          ...
          <UiText>
            Мы верим в силу сотрудничества и командной работы для решения сложных проблем и создания отличных продуктов.
          </UiText>
        </div>
        ...
        <div>
          ...
          <UiText>
            Мы предлагаем конкурентоспособную компенсацию, отличные льготы и долгосрочную стабильность.
          </UiText>
        </div>
        ...
        <div>
          ...
          <UiText>
            Работайте с новейшими технологиями и лучшими практиками в области разработки программного обеспечения и
            дизайна.
          </UiText>
        </div>
      </div>
